# xwb-audio-extractor
Python script that extracts .wav files (and names them) from .xwb/.xgs files using vgmstream
...
- This script will automatically find the number of .wav files inside a wave bank and name them using a provided .xgs file based on their sound cues, then extract them into the same directory as the script
